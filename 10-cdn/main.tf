resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}" # web-dev.surya-devops.site
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"] # web-dev.surya-devops.site
...
module "zone" {
  ...
  records = {
    alb = {
      ...
      name    = "web-cdn" #web-cdn.surya-devops.site
      type    = "A"
